...
function! projs#newseclines#regular#_main_ (...)
    ...
    call add(lines,' ')
    call add(lines,'\ii{listfigs}')
    call add(lines,'\ii{listtabs}')
    call add(lines,'\ii{tabcont}')
    call add(lines,' ')
...
function! projs#newseclines#regular#_build_htlatex_(...)
  ...
  call add(lines,' ')
  call add(lines,'htlatex main main " -cunihtf -utf8"')
  call add(lines,' ')
  call add(lines,'copy *.html %htmloutdir%\ ')
  call add(lines,'copy *.png %htmloutdir%\ ')
  call add(lines,'copy *.css %htmloutdir%\ ')
  call add(lines,' ')
